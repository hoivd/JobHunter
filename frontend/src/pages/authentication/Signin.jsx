    ...
    >
      <div className="w-[40%] h-[65%] flex flex-col justify-center items-center">
        <div className="w-[80%] h-[70%] bg-white/40 p-8 rounded-2xl shadow-[0_0_9px_0px_rgba(0,0,0,0.25)] relative">
          <div className="flex items-center justify-center p-5 rounded-full bg-[#19335A] w-26 h-26 absolute -top-14 left-[calc(50%-48px)] shadow-[0_0_9px_0px_rgba(0,0,0,0.25)]">
            <img src={user} alt="Account" className="w-20" />
          </div>
          <div className="flex flex-col items-center space-y-6 mt-10 w-full h-[70%]">
      ...
      <div className="w-[28%] h-[8%] bg-white/20 absolute top-116 rounded-b-4xl flex justify-center items-center cursor-pointer shadow-[0_0_9px_0px_rgba(0,0,0,0.25)] hover:scale-105 hover:shadow-[0_0_15px_0px_rgba(0,0,0,0.35)] transition-all duration-300">
