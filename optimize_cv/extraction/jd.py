...
def extract_from_directory(app, input_dir: str):
    """
    Đọc tất cả file .txt trong thư mục input_dir
    và gọi JDExtractor.extract_text() cho từng file.
    """
...
if __name__ == "__main__":
    ...
    with Neo4jDriver() as neo_driver:
        ...
        # Gọi hàm trích xuất cho cả thư mục
        input_dir = "./jd_out"   # đổi sang path thư mục JD của bạn
        extract_from_directory(app, input_dir)